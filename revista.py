...
if __name__ == '__main__':
    revista52 = Revista(codigo='564', autor='VARIOS', titulo='Revista Medicina e Investigación Clínica Guayaquil',
                        anio=2023, editorial='Monica Gilbert', disponible=True, cantidad_disponible=10, tipo='VIRTUAL')
    print(revista52)
