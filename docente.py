...
if __name__ == '__main__':
    d1 = Docente(cedula = '0956941127', nombre = 'CHRISTIAN', apellido= 'MERIZALDE', email='cmerizalde@gmail.com', telefono='098898420', direccion='ESTEROS', numero_libros=0, activo=True, carrera='GIG', titulo_3er_nivel='ING', titulo_4to_nivel=',MAE')
    d2 = Docente(cedula = '0917236863', nombre = 'GUILLERMO', apellido= 'VALAREZO', email='gvalarezo@gmail.com', telefono='0982222920', direccion='LA JOYA', numero_libros=0, activo=True, carrera='GIG', titulo_3er_nivel='ING', titulo_4to_nivel=',MAE')
